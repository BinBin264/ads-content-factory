...
def generate_reference_asset_image(project_id: str, asset_type: str) -> Project:
    return project_service.generate_reference_asset_image(project_id, asset_type)
...
def generate_keyframe_slot_image(project_id: str, scene_index: int, slot_id: str) -> Project:
    return project_service.generate_keyframe_slot_image(project_id, scene_index, slot_id)
...
def generate_scene_video(project_id: str, scene_index: int) -> Project:
    return project_service.generate_scene_video(project_id, scene_index)
